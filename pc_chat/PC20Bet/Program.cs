...
namespace WinFrmTalk
{
    ...
    {
        public static FrmBetMain BetMainForm;
        ...
        public static void Main()
        {
            try
            {
                ...
                CreateDirectoryRecursively(dbPath);

                Helpers.LoadFont(Resources.iconfont); //添加字体图标集合文件
                Application.EnableVisualStyles();
                Application.SetCompatibleTextRenderingDefault(false);
                Applicate.initSystemVersion();

                bool bCanRun = GetDotNetVersion("4.0");
                ...
                if(!bCanRun)
                {
                    ...
                    bCanRun = GetDotNetVersion("4.0");
                }
                
                if(bCanRun)
                {
                    BetMainForm = new FrmBetMain();
                    Application.Run(BetMainForm);
                }
            }
            catch (Exception e)
            {
