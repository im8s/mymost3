...
class SumDigitalLR : public LRBase
{
public:
	SumDigitalLR();
	~SumDigitalLR();
...
class BigSmallAndOddEvenLR : public LRBase
{
public:
...
class MinMaxByLR : public LRBase
{
public:
	MinMaxByLR();
	~MinMaxByLR();
...
class LikeCardLR : public LRBase
{
public:
	LikeCardLR();
	~LikeCardLR();
