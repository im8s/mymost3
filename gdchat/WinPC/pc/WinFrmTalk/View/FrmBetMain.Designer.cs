...
namespace WinFrmTalk
{
    partial class FrmBetMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.axBetWidget1.Size = new System.Drawing.Size(1374, 790);
            ...
            this.axBetWidget1.onPBtnLoginClicked += new EventHandler(JumpToLogin);
            this.axBetWidget1.msgArrived("", "", "");
            this.axBetWidget1.sendMsg += new IBetWidgetEvents_sendMsgEventHandler(sendMsg);
        }
        ...
        //private AxBetApp_ocxLib.AxBetWidget axBetWidget;
    }
}