...
namespace WinFrmTalk
{
    public class ImageCroppingBox : Control
    {
        ...
        protected virtual void DrawMagnifier(Graphics g, Point pt)
        {
            ...
            Image bmpNew = ImageHelper.ZoomImage(bmpSrc, 7F);//将图放大7倍
            //放大镜区域
        ...
        public virtual Image GetSelectedImage(ref Rectangle rec)
        {
            ...
            rec = new Rectangle(this._SelectedRectangle.Location, img.Size);
            return img;
        }
        /// <summary>
        /// 清空选择
