...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        isRound = a.getBoolean(R.styleable.CircleImageView_round, false);
        roundSize = a.getInteger(R.styleable.CircleImageView_round_size, 20);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(isRound){
            ...
            canvas.drawRoundRect(rect,roundSize, roundSize, mBitmapPaint);
        }
