...
public class QRcodeActivity extends BaseActivity {
    ...
    public static void getSelfQrCodeBitmap(int size, String userId, String nickName) {
        ...
        AsyncUtils.doAsync(userId, c -> {
            ...
            // 将avatar裁剪为圆形
            Bitmap circleAvatar = BitmapUtil.cropBitmap(avatar);
    ...
    private void initView() {
        ...
        img_head_center = (ImageView) findViewById(R.id.img_head_center);
        avatar_group = findViewById(R.id.avatar_group);
        img_head_center_group = findViewById(R.id.img_head_center_group);
        tv_name = findViewById(R.id.tv_name);
        iv_remarks = findViewById(R.id.iv_remarks);

        if (isgroup) {
            avatar_group.setVisibility(View.VISIBLE);
            img_head_center_group.setVisibility(View.VISIBLE);
        } else {
            avatar.setVisibility(View.VISIBLE);
            img_head_center.setVisibility(View.VISIBLE);
        ...
        if (isgroup) {// 群组头像
            ...
            img_head_center_group.fillData(friend);
        } else {// 用户头像
            AvatarHelper.getInstance().displayAvatar(nickName, userAvatar, avatar, false);
            AvatarHelper.getInstance().displayAvatar(nickName, userAvatar, img_head_center, false);
        }
        // 此bitmap只为无头像的二维码
