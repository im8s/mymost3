...
var Key={
   ...
   success:function(result){
    ...
    if(result.data.pageData.length!=0){
     ...
     for(var i=0;i<result.data.pageData.length;i++){
      html+="<tr align='center' id='" + result.data.pageData[i].id +  "'><td>"+Common.filterHtmlData(result.data.pageData[i].word)
 ...
 commit_keyWord:function(){
  ...
  var addKeyValue = $.trim( Common.getValueForElement("#addKeyValue") );
  if (addKeyValue == ""){
