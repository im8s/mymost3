...
layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
      ...
      ,cols: [[ //表头
          ...
          ,{field: 'url', title: '地址',sort: true, width:250}
          ,{field: 'itunes', title: 'itunes地址',sort: true, width:250}
          ,{field: 'icon', title: '图标',sort: true, width:250}
          ,{field: 'type', title: '类型',sort: true, width:250,templet: function(d){
                    return d.type==0?"App":"网站";
                }}
          ,{fixed: 'right', width:80, title:"操作", align:'left', toolbar: '#friendsterWebsiteListBar'}
        ]]
