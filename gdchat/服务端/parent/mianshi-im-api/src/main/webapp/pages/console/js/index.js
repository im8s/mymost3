...
var manualPay_WithdrawNum = 0;
var manualPay_RechargeNum = 0;
...
/*var int = setInterval(function () {
	...
	$.ajax({
		...
		success:function (result) {
			if(manualPay_WithdrawNum!=0&&manualPay_WithdrawNum<result.count){
				$(".Notice").show();
				$("#withDrawNotice").removeClass("withDrawNotice");
				manualPay_WithdrawNum = result.count;
				playSound();
			}else if(manualPay_WithdrawNum==0){
				manualPay_WithdrawNum = result.count;
			}
	...
	$.ajax({
		...
		success:function (result) {
			if(manualPay_RechargeNum!=0&&manualPay_RechargeNum<result.count){
				$(".Notice").show();
				$("#rechargeNotice").removeClass("rechargeNotice");
				manualPay_RechargeNum = result.count;
				playSound();
			}else if(manualPay_RechargeNum == 0){
				manualPay_RechargeNum = result.count;
			}
		}
	})
...
$(".Recharge").click(function () {
	$(".Notice").hide();
	$("#rechargeNotice").addClass("rechargeNotice");
})
$(".Withdraw").click(function () {
	$(".Notice").hide();
	$("#withDrawNotice").addClass("withDrawNotice");
})
*/
