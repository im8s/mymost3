    ...
    var downLoad ={
        ...
        versions : function () {
            ...
            if (navigator.userAgent.match(/android/i)) {
                var flag = false;
                var openApp = window.open("kuxinimapp://www.shikuandroid.com:80/?appId="+requestData.appId+"&callbackUrl="+testUrl);
                // var openApp = window.open("kuxinimapp://www.shikuandroid.com:80/?appId="+requestData.appId+"&redirectURL="+requestData.callbackUrl);
            ...
            if (navigator.userAgent.match(/(iPhone|iPod|iPad);?/i)) {
              /*  $('.modal-body').html("数据："+requestData.appId+requestData.callbackUrl);
                ...
                window.open("kuxinimapp://www.shikuios.com:80/?appId="+requestData.appId+"&callbackUrl="+testUrl);//ios app协议
                window.setTimeout(function () {
