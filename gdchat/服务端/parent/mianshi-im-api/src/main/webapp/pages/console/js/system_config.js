...
function fillParameter(data){
    ...
    $(".authSwitch").val(data.authSwitch);// 旧设备授权开关
...
layui.use(['form','jquery',"layer"],function() {
    ...
    form.on("submit(systemConfig)",function(data){
       ...
       systemConfig.giftRatio = $(".giftRatio").val();
        ...
        systemConfig.manualPaywithdrawFee = $(".manualPaywithdrawFee").val();
        ...
        systemConfig.authSwitch = $(".authSwitch").val();
        ...
        systemConfig.forbidQuit = $(".forbidQuit").val();
