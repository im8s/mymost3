...
function fillParameter(data){
    ...
    $(".researchSwitch").val(data.researchSwitch)
    $(".withdrawSwitch").val(data.withdrawSwitch)
    $(".withdrawCloseToast").val(data.withdrawCloseToast)
    $(".showGroupManagerAction").val(data.showGroupManagerAction)
...
layui.use(['form','jquery',"layer"],function() {
    ...
    form.on("submit(systemConfig)",function(data){
       ...
       var systemConfig = {};
        ...
        systemConfig.researchSwitch = $(".researchSwitch").val();
        systemConfig.withdrawSwitch = $(".withdrawSwitch").val();
        systemConfig.withdrawCloseToast = $(".withdrawCloseToast").val();
        systemConfig.showGroupManagerAction = $(".showGroupManagerAction").val();
