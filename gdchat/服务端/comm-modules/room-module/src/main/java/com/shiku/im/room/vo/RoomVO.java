...
public class RoomVO {
	...
	private byte forbidQuit=-1;// 开启后，群成员无法退群
	...
	public byte getForbidQuit() {
		return forbidQuit;
	}

	public void setForbidQuit(byte forbidQuit) {
		this.forbidQuit = forbidQuit;
	}
