...
public class JPushUtils extends PushServiceUtils{
	...
	public static final  String appKeyConfig = pushConfig.getJPush_appKey();
	public static final  String masterSecretConfig = pushConfig.getJPush_masterSecret();
	...
	**/ 
	...
	{
		/*JPushClient jpushClient = new JPushClient(pushConfig.getjPush_masterSecret(),pushConfig.getjPush_appKey());
