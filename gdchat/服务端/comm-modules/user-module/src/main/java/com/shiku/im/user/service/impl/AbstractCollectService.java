...
//        ThreadUtils.executeInThread(obj -> {
            for (Document dbObj : documents) {
                ...
                courseMessageDao.addCourseMessage(new ObjectId(),course.getUserId(),course.getCourseId().toString(),dbObj.toJson(),String.valueOf(dbObj.get("messageId")),String.valueOf(dbObj.get("timeSend")));
            }
//        });
